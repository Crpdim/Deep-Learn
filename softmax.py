...
def load_data_fashion_mnist(batch_size, resize=None):  #@save
    ...
    mnist_train = torchvision.datasets.FashionMNIST(
        root="/Users/crpdim/Desktop/Deep-Learn/data", train=True, transform=trans, download=True)
    mnist_test = torchvision.datasets.FashionMNIST(
        root="/Users/crpdim/Desktop/Deep-Learn/data", train=False, transform=trans, download=True)
